    ...
    <div class="container-fluid px-4">
        ...
        <div class="collapse navbar-collapse" id="navbar-ex-7">
            ...
            <div class="navbar-nav ms-4 menu-beranda">
                ...
                <a
                    class="nav-link"
                    href="{{ route('pencarikerja.beranda') }}#home"
                >
                    Home
                </a>
                ...
                <a
                    class="nav-link"
                    href="{{ route('pencarikerja.beranda') }}#about"
                >
                    About
                </a>
            ...
            <div class="navbar-nav ms-auto align-items-lg-center menu-kanan">
                ...
                @if (!Auth::guard('pencarikerja')->check())
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <a
                            class="nav-link dropdown-toggle login-link-beranda"
                            href="#"
                            role="button"
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-beranda">
                            ...
                            <li>
                                <a class="dropdown-item" href="{{ route('perusahaan.login') }}">
                                    Perusahaan
                                </a>
                            </li>

                            <li>
                                <a class="dropdown-item" href="{{ route('pencarikerja.login') }}">
                                    Pencari Kerja
                                </a>
                            </li>
                ...
                @if (Auth::guard('pencarikerja')->user())
                    ...
                    <a
                        class="nav-link profile-link-beranda ms-lg-3
                        {{ request()->routeIs(
