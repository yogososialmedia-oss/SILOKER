                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select name="model_kerja"
                                            ...
                                            <option value="Work From Home"
                                                {{ old('model_kerja') == 'Work From Home' ? 'selected' : '' }}>
                                                Work From Home
                                            </option>

                                            <option value="Work From Office"
                                                {{ old('model_kerja') == 'Work From Office' ? 'selected' : '' }}>
                                                Work From Office
                                            </option>

                                            <option value="Hybrid"
                                                {{ old('model_kerja') == 'Hybrid' ? 'selected' : '' }}>
                                                Hybrid
                                            </option>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select name="tipe_loker"
                                            ...
                                            <option value="job_opportunity"
                                                {{ old('tipe_loker') == 'job_opportunity' ? 'selected' : '' }}>
                                                Job Opportunity
                                            </option>

                                            <option value="internship"
                                                {{ old('tipe_loker') == 'internship' ? 'selected' : '' }}>
                                                Internship
                                            </option>
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <select name="minimal_pendidikan"
                                            ...
                                            <option value="Minimal Pendidikan SMA/sederajat"
                                                {{ old('minimal_pendidikan') == 'Minimal Pendidikan SMA/sederajat' ? 'selected' : '' }}>
                                                Minimal Pendidikan SMA/Sederajat
                                            </option>

                                            <option value="Minimal Pendidikan D1"
                                                {{ old('minimal_pendidikan') == 'Minimal Pendidikan D1' ? 'selected' : '' }}>
                                                Minimal Pendidikan D1
                                            </option>

                                            <option value="Minimal Pendidikan D2"
                                                {{ old('minimal_pendidikan') == 'Minimal Pendidikan D2' ? 'selected' : '' }}>
                                                Minimal Pendidikan D2
                                            </option>

                                            <option value="Minimal Pendidikan D3"
                                                {{ old('minimal_pendidikan') == 'Minimal Pendidikan D3' ? 'selected' : '' }}>
                                                Minimal Pendidikan D3
                                            </option>

                                            <option value="Minimal Pendidikan S1"
                                                {{ old('minimal_pendidikan') == 'Minimal Pendidikan S1' ? 'selected' : '' }}>
                                                Minimal Pendidikan S1
                                            </option>

                                            <option value="Minimal Pendidikan S2"
                                                {{ old('minimal_pendidikan') == 'Minimal Pendidikan S2' ? 'selected' : '' }}>
                                                Minimal Pendidikan S2
                                            </option>

                                            <option value="Minimal Pendidikan S3"
                                                {{ old('minimal_pendidikan') == 'Minimal Pendidikan S3' ? 'selected' : '' }}>
