                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input
                                            type="text"
                                            class="form-control"
                                            value="{{ $loker->perusahaanMitra->nama_perusahaan ?? '-' }}"
                                            readonly>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label">
                                            Poster Loker (Format: JPG / PNG · Maksimal 2MB)
                                        </label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="Work From Home"
                                                {{ old('model_kerja', $loker->model_kerja) == 'Work From Home' ? 'selected' : '' }}>
                                                Work From Home
                                            </option>

                                            <option value="Work From Office"
                                                {{ old('model_kerja', $loker->model_kerja) == 'Work From Office' ? 'selected' : '' }}>
                                                Work From Office
                                            </option>

                                            <option value="Hybrid"
                                                {{ old('model_kerja', $loker->model_kerja) == 'Hybrid' ? 'selected' : '' }}>
                                                Hybrid
                                            </option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="job_opportunity"
                                                {{ old('tipe_loker', $loker->tipe_loker) == 'job_opportunity' ? 'selected' : '' }}>
                                                Job Opportunity
                                            </option>

                                            <option value="internship"
                                                {{ old('tipe_loker', $loker->tipe_loker) == 'internship' ? 'selected' : '' }}>
                                                Internship
                                            </option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @php
                                            $pendidikan = old('minimal_pendidikan', $loker->minimal_pendidikan);
                                        @endphp
                                        ...
                                        <select name="minimal_pendidikan" class="form-select">
                                            ...
                                            <option value="Minimal Pendidikan SMA/sederajat"
                                                {{ $pendidikan == 'Minimal Pendidikan SMA/sederajat' ? 'selected' : '' }}>
                                                Minimal Pendidikan SMA/Sederajat
                                            </option>

                                            <option value="Minimal Pendidikan D1"
                                                {{ $pendidikan == 'Minimal Pendidikan D1' ? 'selected' : '' }}>
                                                Minimal Pendidikan D1
                                            </option>

                                            <option value="Minimal Pendidikan D2"
                                                {{ $pendidikan == 'Minimal Pendidikan D2' ? 'selected' : '' }}>
                                                Minimal Pendidikan D2
                                            </option>

                                            <option value="Minimal Pendidikan D3"
                                                {{ $pendidikan == 'Minimal Pendidikan D3' ? 'selected' : '' }}>
                                                Minimal Pendidikan D3
                                            </option>

                                            <option value="Minimal Pendidikan S1"
                                                {{ $pendidikan == 'Minimal Pendidikan S1' ? 'selected' : '' }}>
                                                Minimal Pendidikan S1
                                            </option>

                                            <option value="Minimal Pendidikan S2"
                                                {{ $pendidikan == 'Minimal Pendidikan S2' ? 'selected' : '' }}>
                                                Minimal Pendidikan S2
                                            </option>

                                            <option value="Minimal Pendidikan S3"
                                                {{ $pendidikan == 'Minimal Pendidikan S3' ? 'selected' : '' }}>
