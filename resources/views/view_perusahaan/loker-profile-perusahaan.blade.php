                ...
                <div class="col-12 mb-4">
                    <div class="card position-relative overflow-hidden border-0 shadow-sm rounded-4">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
                            <img src="{{ $info_perusahaan->logo ? asset('storage/logo_perusahaan/'.$info_perusahaan->logo) : asset('admin-perusahaan/assets/img/avatars/default_profile_perusahaan.jpg') }}" class="rounded-circle mb-2" style="width:100px; height:100px; object-fit:cover; background:#fff; padding:5px;">
                                        ...
                                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-end">
                                            @if (Auth::guard('perusahaanmitra')->user())
                                                <li class="nav-item me-2">
                                                    <a href="{{ route('perusahaan.profile.edit') }}" class="btn btn-sm btn-warning">Edit Profile</a>
                                                </li>
                                            @endif
                                        </ul>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-start gap-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1 d-flex align-items-center gap-2 fw-bold">
                                                ...
                                                <a href="{{ route('perusahaan.profile') }}" class="badge rounded-circle bg-primary d-flex align-items-center justify-content-center position-relative z-5" style="width:16px; height:16px; font-size:10px; line-height:1;">i</a>
                                            </h6>
                                    ...
                                    <div class="d-flex align-items-start gap-3 mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1 d-flex align-items-center gap-2 fw-bold">
                                                ...
                                                <a href="{{ route('admin.profile-perusahaan', $info_perusahaan->id) }}" class="badge rounded-circle bg-primary d-flex align-items-center justify-content-center position-relative z-5" style="width:16px; height:16px; font-size:10px; line-height:1;">i</a>
                                            </h6>
                                            <p class="mb-1 small">{{ $item->tipe_loker == 'job_opportunity' ? 'Job Opportunity' : 'Internship' }}</p>
                                            <p class="d-flex align-items-center gap-1 mb-0 small text-muted">
                                                <i class="bx bx-location-plus"></i>
