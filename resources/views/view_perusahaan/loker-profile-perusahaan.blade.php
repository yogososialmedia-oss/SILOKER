        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <div class="row">
                                        ...
                                        <ul class="navbar-nav mb-2 mb-lg-0 text-end text-lg-start ms-auto ms-lg-0">
                                            ...
                                            @if (Auth::guard('perusahaanmitra')->user())
                                                <li class="nav-item mb-2">
                                                    <a
                                                        class="navbar-brand nav-underline {{ request()->routeIs('perusahaan.profile') ? 'active' : '' }}"
                                            ...
                                            @elseif (Auth::guard('admin')->user())
                                                <li class="nav-item">
                                                    <a
                                                        class="navbar-brand nav-underline {{ request()->routeIs('admin.profile-perusahaan') ? 'active' : '' }}"
                                            ...
                                            @if (Auth::guard('perusahaanmitra')->user())
                                                <li class="nav-item mb-2">
                                                    <a
                                                        class="navbar-brand nav-underline {{ request()->routeIs('perusahaan.loker.profile') ? 'active' : '' }}"
                                            ...
                                            @elseif (Auth::guard('admin')->user())
                                                <li class="nav-item mb-2">
                                                    <a
                                                        class="navbar-brand nav-underline {{ request()->routeIs('admin.lowongan-kerja-perusahaan') ? 'active' : '' }}"
                                        ...
                                        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-end">
                                            ...
                                            @if (Auth::guard('perusahaanmitra')->user())
                                                <li class="nav-item me-2">
                                                    <a
                                                        href="{{ route('perusahaan.profile.edit') }}"
                    ...
                    @foreach($loker as $item)
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-6 mb-5">
                            ...
                            <div class="card h-100 loker-card-beranda position-relative">
                                ...
                                {{-- LINK AREA --}}
                                <a
                                    href="{{ route('perusahaan.loker.tampilan', $item->id) }}"
                                ...
                                <div class="card-body position-relative">
                                    ...
                                    <div class="d-flex align-items-start gap-3 mb-3">
                                        ...
                                        <img
                                            src="{{ $item->perusahaanMitra->logo_url }}"
                ...
                @elseif (Auth::guard('admin')->user())
                    ...
                    {{-- (Bagian admin tetap sama, hanya dirapikan indentasinya) --}}
                    ...
                    <ul class="pagination justify-content-center">
                        ...
                        @for ($i = 1; $i <= $loker->lastPage(); $i++)
                            <li class="page-item {{ $loker->currentPage() == $i ? 'active' : '' }}">
                                <a class="page-link" href="{{ $loker->url($i) }}">
                                    {{ $i }}
                                </a>
                            </li>
                        @endfor
