            ...
            <div class="row">
                    ...
                    <div class="card position-relative overflow-hidden border-0 shadow-sm rounded-4">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
                            ...
                            @if($info_perusahaan->status_akun == 'verifikasi_gagal')
                                <button class="btn p-0 border-0 bg-transparent {{ $statusClass[$info_perusahaan->status_akun] }}" data-bs-toggle="modal" data-bs-target="#modalStatus">
                ...
                <div class="col-12 mb-5">
                    <div class="card shadow-sm rounded-4 p-4">
                        ...
                        <p class="mb-0">{{ $info_perusahaan->no_telp_perusahaan ?? '-' }}</p>
                    </div>
                </div>
            </div>
