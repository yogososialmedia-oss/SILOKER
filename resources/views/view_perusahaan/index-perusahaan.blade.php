                ...
                <div class="col-12 mb-4">
                    <div class="card position-relative overflow-hidden border-0 shadow-sm rounded-4">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
                            <img src="{{ $info_perusahaan->logo ? asset('storage/logo_perusahaan/'.$info_perusahaan->logo) : asset('admin-perusahaan/assets/img/avatars/default_profile_perusahaan.jpg') }}" 
                            ...
                            @if($info_perusahaan->status_akun == 'verifikasi_gagal')
                                <button class="btn p-0 border-0 bg-transparent {{ $statusClass[$info_perusahaan->status_akun] }}" 
                                        data-bs-toggle="modal" data-bs-target="#modalStatus">
                                    {{ $statusText[$info_perusahaan->status_akun] }} <i class="bx bx-error-circle"></i>
                                </button>
                            @else
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content rounded-4">
                            <div class="modal-header">
                                <h5 class="modal-title text-danger">Keterangan Verifikasi Gagal</h5>
                            ...
                            <div class="modal-footer">
                                @if (Auth::guard('perusahaanmitra')->user())
                                    <a href="{{ route('perusahaan.profile.edit') }}" class="btn btn-warning">Perbaiki</a>
                                @endif
                            </div>
                        </div>
                    </div>
