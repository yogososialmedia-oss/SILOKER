                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="{{ $pelamar?->nama_pencari_kerja ?? '-' }}"
                                        disabled
                                    >
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="{{ $pelamar?->pendidikan_terakhir ?? '-' }}"
                                        disabled
                                    >
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="{{ $pelamar?->email_pencari_kerja ?? '-' }}"
                                        disabled
                                    >
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="{{ $pelamar?->no_telp_pencari_kerja ?? '-' }}"
                                        disabled
                                    >
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input
                                        type="text"
                                        class="form-control"
                                        value="{{ $pelamar?->alamat_pencari_kerja ?? '-' }}"
                                        disabled
                                    >
                                </div>
                            ...
                            <div class="text-end mt-4">
                                ...
                                <a
                                    href="{{ route('perusahaan.apply', $loker->id) }}"
