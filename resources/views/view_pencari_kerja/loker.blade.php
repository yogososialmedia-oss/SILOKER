                ...
                <div class="col-md-3 mb-4">
                    ...
                    <select name="tipe_loker" class="form-select">
                        ...
                        <option value="internship"
                            {{ ($filters['tipe_loker'] ?? '') == 'internship' ? 'selected' : '' }}>
                            Internship
                        </option>

                        <option value="job_opportunity"
                            {{ ($filters['tipe_loker'] ?? '') == 'job_opportunity' ? 'selected' : '' }}>
                            Job Opportunity
                        </option>
                    </select>
                </div>
                ...
                <div class="card h-100 loker-card-beranda position-relative">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="d-flex align-items-start gap-3 mb-3">
                            ...
                            <img
                                src="{{ $loker->perusahaanMitra->logo_url }}"
    ...
    fetch('https://kanglerian.my.id/api-wilayah-indonesia/api/provinces.json')
        ...
        .then(data => {
            ...
            data.forEach(item => {
                ...
                opt += `
                    <option value="${item.name}" data-id="${item.id}" ${selected}>
                        ${item.name}
                    </option>
                `;
            });
