    ...
    <div class="content-wrapper-user">
            ...
            <form method="GET" action="{{ route('pencarikerja.loker.index') }}">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-3 mb-4">
                        ...
                        <select name="tipe_loker" class="form-select">
                            ...
                            <option value="internship" {{ ($filters['tipe_loker'] ?? '') == 'internship' ? 'selected' : '' }}> Internship </option>
                            <option value="job_opportunity" {{ ($filters['tipe_loker'] ?? '') == 'job_opportunity' ? 'selected' : '' }}> Job Opportunity </option>
                        </select>
                    </div>
                    <div class="col-md-3 mb-4">
                        ...
                        <select name="model_kerja" class="form-select">
                            ...
                            <option value="Work From Office" {{ request('model_kerja') == 'Work From Office' ? 'selected' : '' }}> Work From Office </option>
                            <option value="Work From Home" {{ request('model_kerja') == 'Work From Home' ? 'selected' : '' }}> Work From Home </option>
                            <option value="Hybrid" {{ request('model_kerja') == 'Hybrid' ? 'selected' : '' }}> Hybrid </option>
                        </select>
                    </div>
                    <div class="col-md-3 mb-4">
                        ...
                        <select name="minimal_pendidikan" class="form-select">
                            ...
                            <option value="Minimal Pendidikan SMA/sederajat" {{ request('minimal_pendidikan') == 'Minimal Pendidikan SMA/sederajat' ? 'selected' : '' }}> Minimal Pendidikan SMA / Sederajat </option>
                            <option value="Minimal Pendidikan D1" {{ request('minimal_pendidikan') == 'Minimal Pendidikan D1' ? 'selected' : '' }}> Minimal Pendidikan D1 </option>
                            <option value="Minimal Pendidikan D2" {{ request('minimal_pendidikan') == 'Minimal Pendidikan D2' ? 'selected' : '' }}> Minimal Pendidikan D2 </option>
                            <option value="Minimal Pendidikan D3" {{ request('minimal_pendidikan') == 'Minimal Pendidikan D3' ? 'selected' : '' }}> Minimal Pendidikan D3 </option>
                            <option value="Minimal Pendidikan S1" {{ request('minimal_pendidikan') == 'Minimal Pendidikan S1' ? 'selected' : '' }}> Minimal Pendidikan S1 </option>
                            <option value="Minimal Pendidikan S2" {{ request('minimal_pendidikan') == 'Minimal Pendidikan S2' ? 'selected' : '' }}> Minimal Pendidikan S2 </option>
                            <option value="Minimal Pendidikan S3" {{ request('minimal_pendidikan') == 'Minimal Pendidikan S3' ? 'selected' : '' }}> Minimal Pendidikan S3 </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row mb-5">
                    <div class="col-12 d-flex justify-content-end gap-3">
                        <a href="{{ route('pencarikerja.loker.index', ['reset' => 1]) }}" class="btn btn-secondary px-4"> Reset </a>
                        <button type="submit" class="btn btn-primary px-4"> <i class="bx bx-search me-1"></i> Cari Lowongan </button>
                    </div>
                </div>
            </form>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 mb-5">
                        <div class="card h-100 loker-card-beranda position-relative">
                            ...
                            <div class="card-body position-relative">
                                {{-- TANGGAL --}}
                                <p class="text-end fs-9 mb-2"> {{ $loker->tanggal_mulai_loker->format('d M Y') }} - {{ $loker->tanggal_berakhir_loker->format('d M Y') }} </p>
                                {{-- HEADER --}}
                                <div class="d-flex align-items-start gap-3 mb-3">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="mb-1 small"> {{ $loker->tipe_loker == 'job_opportunity' ? 'Job Opportunity' : 'Internship' }} </p>
                                        <p class="d-flex align-items-center gap-1 mb-0 small text-muted">
                                            <i class="bx bx-location-plus"></i> <span>{{ $loker->kabupaten }}</span>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <p class="d-flex align-items-start gap-2 mb-1">
                                    <i class="bx bx-buildings"></i> <span>{{ $loker->model_kerja }}</span>
                                </p>
                                <p class="d-flex align-items-start gap-2 mb-1">
                                    <i class="bx bx-book-reader"></i> <span>{{ $loker->minimal_pendidikan }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <footer class="content-footer footer bg-footer-theme">
            <div class="container-xxl">
                <div class="footer-container d-flex justify-content-between py-4"> ©2026 Yogo & Wahyu </div>
            </div>
        </footer>
