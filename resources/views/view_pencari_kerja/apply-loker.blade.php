                        ...
                        <div class="card-body">
                            ...
                            <form id="formApply"
                                ...
                                <div class="alert alert-info mb-4">
                                    ...
                                    Lamaran pekerjaan ini akan menggunakan
                                    <strong>LinkedIn</strong> dan
                                    <strong>CV</strong>
                                    yang tersimpan di
                                    ...
                                    <a href="{{ route('pencarikerja.profile.edit') }}" class="alert-link">
                    ...
                    <div class="modal-footer">
                        ...
                        @if($pencari->cv || (!$pencari->cv && $pencari->linkedin))
                            ...
                            <button
                                type="button"
                                class="btn btn-primary"
                                onclick="document.getElementById('formApply').submit();"
                            >
                                Ya, Lanjutkan
                            </button>
