                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-ex-15">
                                        ...
                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                            ...
                                            <li class="nav-item mb-2">
                                                <a
                                                    class="navbar-brand nav-underline {{ request()->routeIs('pencarikerja.profile.perusahaan') ? 'active' : '' }}"
                                            ...
                                            <li class="nav-item mb-2">
                                                <a
                                                    class="navbar-brand nav-underline {{ request()->routeIs('pencarikerja.loker.profile.perusahaan') ? 'active' : '' }}"
                ...
                @foreach($loker as $item)
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-6 mb-5">
                        ...
                        <div class="card h-100 loker-card-beranda position-relative">
                            ...
                            <a
                                href="{{ route('pencarikerja.loker.show', $item->id) }}?from=perusahaan&perusahaan_id={{ $info_perusahaan->id }}"
