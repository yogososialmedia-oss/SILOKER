                    ...
                    <div class="card loker-card-beranda">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-end gap-2 pt-3 border-top">
                                ...
                                @if($from === 'perusahaan')
                                    <a href="{{ route('pencarikerja.loker.profile.perusahaan', request('perusahaan_id')) }}" class="btn btn-secondary"> Kembali </a>
                                @else
                                    <a href="{{ route('pencarikerja.loker.index', request()->except(['from','perusahaan_id'])) }}" class="btn btn-secondary"> Kembali </a>
                                @endif
                                ...
                                @if($isOpen)
                                    <a href="{{ route('pencarikerja.loker.apply.form', $loker) }}" class="btn btn-primary"> Apply </a>
                                @else
                                    <button class="btn btn-secondary" disabled onclick="alert('Lowongan sudah ditutup.')"> Lowongan Ditutup </button>
                                @endif
                            </div>
