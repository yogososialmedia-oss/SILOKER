                                        ...
                                        <div class="row justify-content-center">
                                            @foreach($chunk as $loker)
                                                <div class="col-md-6 mb-4">
                                                    {{-- 2 kolom --}}
                                                    <a href="{{ route('pencarikerja.loker.show', $loker->id) }}" class="text-decoration-none">
                                                        <div class="card h-100 loker-card-beranda position-relative">
                                                            {{-- LINK --}}
                                                            <a href="{{ route('pencarikerja.loker.show', $loker->id) }}" class="stretched-link"></a>
                                                            <div class="card-body position-relative">
                                                                {{-- TANGGAL --}}
                                                                <p class="text-end fs-9 mb-2">
                                                                    {{ $loker->tanggal_mulai_loker->format('d M Y') }} - {{ $loker->tanggal_berakhir_loker->format('d M Y') }}
                                                                </p>
                                                                {{-- HEADER --}}
                                                                <div class="d-flex align-items-start gap-3 mb-3">
                                                                    <img src="{{ $loker->perusahaanMitra->logo_url ?? asset('default.png') }}" style="width:60px; height:60px; object-fit:cover;" class="rounded shadow-sm" alt="">
                                                                    <div class="flex-grow-1">
                                                                        <h6 class="mb-1 fw-bold d-flex align-items-center gap-2">
                                                                            ...
                                                                            {{-- Icon Info --}}
                                                                            <a href="{{ route('pencarikerja.profile.perusahaan', $loker->perusahaanMitra->id) }}" class="badge rounded-circle bg-primary d-flex align-items-center justify-content-center position-relative z-5" style="width:16px; height:16px; font-size:10px;">
                                                                                i
                                                                            </a>
                                                                        </h6>
                                                                        <p class="mb-1 small">
                                                                ...
                                                                <div class="d-flex align-items-center mb-3">
                                                                    <h5 class="mb-0 text-dark">{{ $loker->jabatan }}</h5>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 home-text-beranda">
                            <h1> FIND YOUR<br> DREAM JOB<span class="tanda-seru-color">!</span> </h1>
                            <p class="home-desc">
                                Temukan peluang karier terbaik yang selaras dengan keahlian, minat, dan passionmu. Jelajahi berbagai lowongan pekerjaan dari perusahaan terpercaya, kembangkan potensi diri, serta raih masa depan yang lebih cerah dan berkelanjutan melalui langkah karier yang tepat.
                            </p>
                        </div>
                        <div class="col-lg-6 text-center">
                            <img src="{{ asset('admin-perusahaan/assets/img/avatars/beranda1.png') }}" class="img-fluid hero-image-beranda">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="career-center-box mb-5 pb-4 border-bottom border-primary text-center">
                    ...
                    <div class="mx-auto" style="max-width: 850px;">
                        <p class="mb-3">
                            Career Center ITB STIKOM Bali merupakan sebuah platform digital yang didedikasikan untuk membantu mahasiswa aktif maupun alumni ITB STIKOM Bali dalam menemukan dan mengembangkan peluang karier yang sesuai dengan minat, bakat, dan kompetensi mereka.
                        </p>
                        <p class="mb-6">
                            Selain sebagai media pencarian kerja, Career Center ITB STIKOM Bali juga berperan sebagai jembatan penghubung antara dunia pendidikan dan dunia industri, guna meningkatkan kesiapan lulusan dalam menghadapi persaingan dunia kerja.
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        ...
                        <p><strong>Kampus Renon:</strong><br>Jl. Raya Puputan No. 86 Renon – Denpasar<br>Telp: (0361) 244445</p>
                        <p><strong>Kampus Jimbaran:</strong><br>Jl. Raya Kampus Udayana Jimbaran Bali<br>Telp: (0361) 8953537</p>
                        <p><strong>Kampus Abiansemal:</strong><br>Jl. Janger Dauh Yeh Cani, Badung, Bali<br>Telp: 0856-3700-803</p>
                    </div>
                    <!-- KOLOM 2 -->
                    <div class="col-lg-4 mb-4">
