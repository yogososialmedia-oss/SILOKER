                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-ex-15">
                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                            <li class="nav-item">
                                                <a class="navbar-brand nav-underline {{ request()->routeIs('admin.apply.profile', $apply->id) ? 'active' : '' }}"
                                                    href="{{ route('admin.apply.profile', $apply->id) }}">
                                                    Tentang Saya
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="navbar-brand nav-underline {{ request()->routeIs('admin.apply.history', $apply->id) ? 'active' : '' }}"
