                ...
                <div class="col-12 mb-5">
                    <div class="card position-relative overflow-hidden border-0 shadow-sm rounded-4">
                        ...
                        <div class="position-absolute top-50 start-50 translate-middle text-center text-white">
                            ...
                            <img
                                src="{{ $apply->pencariKerja->foto_pencari_kerja
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbar-ex-15">
                                        ...
                                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="navbar-brand nav-underline {{ request()->routeIs('admin.apply.profile', $apply->id) ? 'active' : '' }}"
                                                    href="{{ route('admin.apply.profile', $apply->id) }}"
                                                >
                                                    Tentang Saya
                                                </a>
                                            </li>
                                            ...
                                            <li class="nav-item">
                                                <a
                                                    class="navbar-brand nav-underline {{ request()->routeIs('admin.apply.history', $apply->id) ? 'active' : '' }}"
                                                    href="{{ route('admin.apply.history', $apply->id) }}"
                                                >
                                                    History Apply
                                                </a>
                                            </li>
                    ...
                    <div class="card">
                        ...
                        <div class="bg-white p-4">
                            ...
                            <p class="mb-2 text-muted">
                                {{ $apply->pencariKerja->deskripsi_diri ?? 'Belum ada deskripsi diri' }}
                            </p>


                            <h6 class="fw-bold mb-1">Alamat</h6>
                            <p>
                                {{ $apply->pencariKerja->alamat_pencari_kerja }}
                            </p>
                            ...
                            @if($apply->pencariKerja->linkedin)
                                <a
                                    href="{{ $apply->pencariKerja->linkedin }}"
                                    target="_blank"
                            ...
                            <p>
                                {{ $apply->pencariKerja->pendidikan_terakhir ?? '-' }}
                            </p>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body p-0">
                                            ...
                                            @if($apply->pencariKerja->cv)
                                                ...
                                                <iframe
                                                    src="{{ asset('storage/'.$apply->pencariKerja->cv) }}"
                                                    width="100%"
                                                    height="600px"
                                                    style="border:none;"
                                                ></iframe>
