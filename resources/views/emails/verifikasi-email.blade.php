<h2>
    Halo, {{ $user->nama_perusahaan ?? $user->nama_pencari_kerja }}
</h2>
...
<p>
    Verifikasi email ini penting untuk mengamankan akun Anda serta memungkinkan Anda
    mengakses seluruh fitur yang tersedia pada sistem.
</p>

<p style="margin: 20px 0;">
    <a 
        href="{{ route('verifikasi.email', ['type' => $type, 'token' => $token]) }}"
